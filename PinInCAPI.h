...
#include <stddef.h>
	...
	int PinInCpp_PinInSerialize(PinInCpp_PinIn pinin, const char* path);//返回值为真则写入成功
	...
	PinInCpp_TreeSearcher PinInCpp_TreeSearcherNewPinIn(PinInCpp_TreeSeracher_Logic logic, PinInCpp_PinIn pinin);
	void PinInCpp_TreeSearcherFree(PinInCpp_TreeSearcher pinin);
	...
	int PinInCpp_TreeSearcherSerialize(PinInCpp_TreeSearcher tree, const char* path);//返回值为真则写入成功
